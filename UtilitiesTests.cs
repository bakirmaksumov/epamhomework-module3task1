...
namespace Task1.Tests
{
    ...
    public class Tests
    {
        ...
        public void IndexOf_Products_ReturnsTwo()
        {
            ...
            int index = Utilities.IndexOf(products, product => product.Name == productToFind.Name && product.Price == productToFind.Price);
        ...
        public void IndexOf_NullProducts_ThrowsArgumentNullException()
        {
            ...
            {
                var productToFind = new Product("Product 3", 30.0d);
                int index = Utilities.IndexOf(null, product => product.Name == productToFind.Name && product.Price == productToFind.Price);
